...
def register_view(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Ubah dari 'reading_list' menjadi 'home'
...
def import_data(request):
    if request.method == 'POST' and request.FILES.get('import_file'):
        ...
        # Gunakan first() agar tidak crash jika ID 1 tidak ada
        ...
        for line in lines:
            ...
            try:
                ...
                # Inisialisasi variabel dengan nilai default model Anda
                chapters = 0
                season = "-"
                ...
                # Gabungkan notes, pastikan tidak kosong
                ...
                # Print error ke log server untuk debugging
...
def reading_add(request):
    ...
    if request.method == 'POST':
        ...
        ReadingItem.objects.create(
            ...
            rating=request.POST.get('rating', '-'), # Mengganti hype menjadi rating
            notes=request.POST.get('notes', '-'),
            image=request.FILES.get('image'), # Penting untuk menangani file upload
